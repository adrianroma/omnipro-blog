...
use Omnipro\Blog\Api\DataRepositoryInterface;
use Omnipro\Blog\Api\Data\DataInterface;
use Omnipro\Blog\Api\Data\DataInterfaceFactory;
use Omnipro\Blog\Api\Data\DataSearchResultsInterfaceFactory;
use Omnipro\Blog\Model\ResourceModel\Data as ResourceData;
use Omnipro\Blog\Model\ResourceModel\Data\CollectionFactory as DataCollectionFactory;
...
class DataRepository implements DataRepositoryInterface
{
    ...
    public function getById($dataId)
    {
        if (!isset($this->instances[$dataId])) {
            /** @var \Omnipro\Blog\Api\Data\DataInterface|\Magento\Framework\Model\AbstractModel $data */
     ...
     * @return \Omnipro\Blog\Api\Data\DataSearchResultsInterface
     */
    public function getList(SearchCriteriaInterface $searchCriteria)
    {
        /** @var \Omnipro\Blog\Api\Data\DataSearchResultsInterface $searchResults */
        $searchResults = $this->searchResultsFactory->create();
        $searchResults->setSearchCriteria($searchCriteria);

        /** @var \Omnipro\Blog\Model\ResourceModel\Data\Collection $collection */
